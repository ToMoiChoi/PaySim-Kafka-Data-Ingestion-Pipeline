...
TABLES = {
    ...
    "fact_transactions": [
        ...
        bigquery.SchemaField("oldbalanceOrg", "FLOAT64", mode="NULLABLE",
                             description="Số dư ban đầu của sender"),
        bigquery.SchemaField("newbalanceOrig", "FLOAT64", mode="NULLABLE",
                             description="Số dư sau giao dịch của sender"),
        bigquery.SchemaField("oldbalanceDest", "FLOAT64", mode="NULLABLE",
                             description="Số dư ban đầu của receiver"),
        bigquery.SchemaField("newbalanceDest", "FLOAT64", mode="NULLABLE",
    ...
    "dim_users": [
        ...
        bigquery.SchemaField("account_balance", "FLOAT64", mode="NULLABLE",
