...
def main():
    ...
    print("=" * 65)
    print("  BigQuery Star Schema Init - Native Crypto Pipeline")
    print("=" * 65)
    ...
    try:
        ...
        TABLES = {
            ...
            "dim_volume_category": [
                bigquery.SchemaField("volume_category", "STRING", mode="REQUIRED"),
                bigquery.SchemaField("description", "STRING"),
                bigquery.SchemaField("min_usd", "FLOAT64"),
                bigquery.SchemaField("max_usd", "FLOAT64"),
            ],
            "dim_crypto_pair": [
                bigquery.SchemaField("crypto_symbol", "STRING", mode="REQUIRED"),
